 ...
 */
function Flag({ ref, ...props }: FlagProps & { ref?: React.Ref<HTMLElement> }) {
...
const FlagWithStatics = Flag as typeof Flag & {
  create: (val: any, options?: Record<string, any>) => React.ReactElement | null
}

FlagWithStatics.create = createShorthandFactory(FlagWithStatics, (value) => ({ name: value }))

export default FlagWithStatics
